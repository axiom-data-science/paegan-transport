...
class ExportTest(unittest.TestCase):
    ...
    def test_h5_particle_multipoint(self):
        ex.H5ParticleMultiPoint.export(folder=self.output_path, h5_file=os.path.normpath(os.path.join(os.path.dirname(__file__), "./resources/files/hdf5_output.h5")))
